...
module "eks" {
  ...
  access_entries = {
    "argocd_555935582951" = {
      cluster_name  = "${var.cluster_name}"
      principal_arn = "arn:aws:iam::555935582951:role/argocd-mgmt-barclays-corp"
      policy_associations = {
        argocdAdminAccess = {
...
resource "aws_ssm_parameter" "clusters" {
  ...
  value = jsonencode({
    ...
    argocd_role_arn        = "arn:aws:iam::555935582951:role/argocd-mgmt-barclays-corp"
  })
}
...
resource "aws_eks_identity_provider_config" "dex" {
    ...
    oidc {
      ...
      issuer_url                    = "https://dex.gitops.ing"
